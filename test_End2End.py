...
def test_StudentDetails():
    ...
    file = open('C:\\LocalRepos\\Automation_Python\\Addstudent.json', 'r')
    ...
    tech_file = open('C:\\LocalRepos\\Automation_Python\\TechnicalDetails.json', 'r')
    ...
    address_file = open('C:\\LocalRepos\\Automation_Python\\Address.json', 'r')
